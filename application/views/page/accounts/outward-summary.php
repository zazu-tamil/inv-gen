                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td class="text-right"> 
                                        <span data-toggle="modal" data-target="#view_modal"  class="btn_breakup" data-ac-type="<?php echo $ac_typ ; ?>" data-id="<?php if(isset($ls[$mon]['id'])) echo $ls[$mon]['id'];?>" data-mon="<?php if(isset($ls[$mon]['num_mon'])) echo $ls[$mon]['num_mon'];?>">
                                        <?php if(isset($ls[$mon]['outward'])) echo number_format($ls[$mon]['outward'],2); else echo '0.00'?>
                                        </span>    
                                    </td> 
                                    <?php } ?> 
