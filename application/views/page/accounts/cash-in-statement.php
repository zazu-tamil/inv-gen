<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>Inward Statement</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Reports</a></li> 
    <li class="active">Inward Statement</li>
  </ol>
</section>
<!-- Main content -->
<section class="content"> 
  <!-- Default box -->
    <div class="box box-info no-print"> 
        ...
        <div class="box-body">
             <form method="post" action="<?php echo site_url('cash-in-statement')?>" id="frmsearch">          
             <div class="row">   
  ...
  <div class="box box-info" >
    ...
    <div class="box-body table-responsive"> 
       <table class="table table-striped table-bordered table-hover" id="statement">
                    <caption class="hide">
                         Inward Statement : [ <?php echo date('d-m-Y', strtotime($srch_from_date));?> to <?php echo date('d-m-Y', strtotime($srch_to_date));?> ]  
                    </caption>
                    <thead>
                        <tr>
                            <th>#</th>  
