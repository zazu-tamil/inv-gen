<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>NA-Inward Statement</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Reports</a></li> 
    <li class="active">NA-Inward Statement</li>
  </ol>
</section>
<!-- Main content -->
<section class="content"> 
  <!-- Default box -->
    <div class="box box-info no-print"> 
        ...
        <div class="box-body">
             <form method="post" action="<?php echo site_url('na-cash-in-statement')?>" id="frmsearch">          
             <div class="row">   
                 ...
                 <div class="form-group col-md-3">
                    ...
                    <?php echo form_dropdown('srch_inward_from',array('' => 'All') + $inward_from_opt  ,set_value('srch_inward_from', $srch_inward_from) ,' id="srch_inward_from" class="form-control"');?>                                             
                 </div>
  ...
  <div class="box box-info" >
    <div class="box-header with-border">
        <h4 class="">Inward Statement : [ <?php echo date('d-m-Y', strtotime($srch_from_date));?> to <?php echo date('d-m-Y', strtotime($srch_to_date));?> ]  </h4>     
    </div>
    <div class="box-body table-responsive"> 
       <table class="table table-striped table-bordered table-hover" id="statement">
                    <caption class="hide">
                         NA-Inward Statement : [ <?php echo date('d-m-Y', strtotime($srch_from_date));?> to <?php echo date('d-m-Y', strtotime($srch_to_date));?> ]  
                    </caption>
                    <thead>
                        <tr>
                            <th>#</th>  
                    ...
                    <tbody> 
                       ...
                       <?php
                        ...
                        <tr>
                            ...
                            <td><?php echo $info['sub_account_headlvl3_name']; ?></td> 
