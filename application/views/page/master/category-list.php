                ...
                <tbody>
                    ...
                    foreach ($record_list as $j => $ls) {
                        ...
                        <tr class="mb-3">
                            ...
                            <td><?php echo $ls['category_name'] ?></td>
                            <td><?php echo $ls['status'] ?></td>
                            <td class="text-center">
                                <button data-toggle="modal" data-target="#edit_modal"
                                    value="<?php echo $ls['category_id'] ?>" class="edit_record btn btn-primary btn-xs"
                                    title="Edit"><i class="fa fa-edit"></i></button>
                            </td>
                            <td class="text-center">
                                <button value="<?php echo $ls['category_id'] ?>" class="del_record btn btn-danger btn-xs"
